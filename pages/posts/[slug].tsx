...
export default function Post({ post, posts, preview }) {
  ...
  // useEffect(() => {
  //   if (fbclid) router.replace(`https://dailyxpresss.com/${router.query.slug}`)
  // })
  ...
  return (
    <Layout preview={preview}>
      <Head>
        <div className="mg-nav-widget-area-back" style={{ backgroundImage: "url('https://dailyxpresss.com/wp-content/themes/newses/images/head-back.jpg');" }}>
                  ...
                  <div className="row align-items-center">
                    <div className="col-md-4 text-center-xs">
                      <span className="navbar-brand">
                        <img width="80" height="80" src="https://i0.wp.com/dailyxpresss.com/wp-content/uploads/Asset-2.png?fit=80%2C80&amp;ssl=1" className="custom-logo" alt="" decoding="async" />
                      </span>
                      <div className="site-branding-text">
                        <h1 className="site-title"><a href="https://dailyxpresss.com/" rel="home">Daily Express</a></h1>
